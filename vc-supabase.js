...
(function(){
  ...
  window.VC_customerSignUp=async function(email,password,fullName,phone){
    const j=await authFetch('/auth/v1/signup',{email,password,data:{full_name:fullName||'',phone:phone||''}});
    return j;
  };
